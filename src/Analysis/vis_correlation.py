...
unique_images['bubble_size'] = unique_images['focus_subject'].map(size_map)


print("===================================================================================================")
print("5) DataFrame with bubble_size column added:")
print(unique_images.head(n=3))
...
sns.scatterplot(data=unique_images, x='People Count', y='focus_subject',size = 'bubble_size', sizes=(30, 300), alpha=0.7, hue='image_sentiment',palette=custom_palette)
